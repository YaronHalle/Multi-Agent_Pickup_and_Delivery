...
class LNS_Wrapper_Class(object):
    ...
    def run(self):
        ...
        return_value = self.cpp.lib.invoke_lns(self.time_limit, self.random_seed, byref(pointer_to_agents_paths))
